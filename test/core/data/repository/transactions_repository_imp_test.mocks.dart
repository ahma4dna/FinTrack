...
// in fintrack/test/core/data/repository/transactions_repository_imp_test.dart.
...
import 'package:fintrack/core/data/dao/transactions_daos.dart' as _i6;
...
class _Fake$CategoriesTableTable_7 extends _i1.SmartFake
  ...
  _Fake$CategoriesTableTable_7(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _Fake$TransactionsTableTable_8 extends _i1.SmartFake
    implements _i2.$TransactionsTableTable {
  _Fake$TransactionsTableTable_8(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _FakeTransactionsDaosManager_9 extends _i1.SmartFake
    implements _i6.TransactionsDaosManager {
  _FakeTransactionsDaosManager_9(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
/// A class which mocks [TransactionsDaos].
///
/// See the documentation for Mockito's code generation for more information.
class MockTransactionsDaos extends _i1.Mock implements _i6.TransactionsDaos {
  MockTransactionsDaos() {
  ...
  _i2.$TransactionsTableTable get transactionsTable => (super.noSuchMethod(
    ...
    returnValue: _Fake$TransactionsTableTable_8(
      this,
      Invocation.getter(#transactionsTable),
    ),
  ...
  @override
  _i6.TransactionsDaosManager get managers => (super.noSuchMethod(
    Invocation.getter(#managers),
    returnValue: _FakeTransactionsDaosManager_9(
      this,
      Invocation.getter(#managers),
    ),
  ) as _i6.TransactionsDaosManager);

  @override
  _i7.Future<List<_i2.CategoriesTableData>> getCategory() =>
      (super.noSuchMethod(
        Invocation.method(#getCategory, []),
        returnValue: _i7.Future<List<_i2.CategoriesTableData>>.value(
          <_i2.CategoriesTableData>[],
        ),
      ) as _i7.Future<List<_i2.CategoriesTableData>>);

  @override
  _i7.Future<int> insertTransaction(_i2.TransactionsTableCompanion? txn) =>
      (super.noSuchMethod(
  ...
  @override
  _i7.Stream<List<_i9.TransactionWithDetails>> watchByWallet(int? walletId) =>
      (super.noSuchMethod(
        Invocation.method(#watchByWallet, [walletId]),
        returnValue: _i7.Stream<List<_i9.TransactionWithDetails>>.empty(),
      ) as _i7.Stream<List<_i9.TransactionWithDetails>>);
  ...
  _i7.Future<T> exclusively<T>(_i7.Future<T> Function()? action) =>
      (super.noSuchMethod(
        ...
        returnValue:
            ...
            _FakeFuture_10<T>(this, Invocation.method(#exclusively, [action])),
      ) as _i7.Future<T>);
